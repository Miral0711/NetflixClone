...
export const TRENDING = MOVIE_DATA.results.slice(0, 6);
export const POPULAR = MOVIE_DATA.results.slice(6, 12);
export const TOP_RATED = MOVIE_DATA.results.slice(12, 18);
export const ACTION = MOVIE_DATA.results.slice(18, 24);
